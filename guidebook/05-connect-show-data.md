...
When you press on the **Data** tab, it will switch to our `DataView`, which will show the list of Incident numbers and short descriptions sourced from the instance by our `DataModel`, utilising the Mobile SDK!

<img src="images/05-06-list.png" width=300/><br />
A list of incidents retrieved from the instance by the Mobile SDK.<br /><br />

These incidents are loaded when we click on the Data tab, and so depending on the speed of your internet connection they may take a while to appear. For a production version of the app, we'd probably want a loading screen and not to just show a blank white screen to confuse our users!
